...
def test_source_bronze():
    ...
    bronze_table = Variable.get("BRONZE_TABLE", default_var="lakehouse.sales")  # postgres table
    nessie_uri = Variable.get("NESSIE_URI", default_var="http://lakehouse-nessie:19120/api/v2")
